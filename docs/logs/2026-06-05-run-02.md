...
- VitePress 构建：通过。命令：`/Users/apple/.nvm/versions/node/v24.15.0/bin/node node_modules/vitepress/bin/vitepress.js build docs`，构建耗时约 1.94 秒。
- `docs:dev`：通过。命令：`PATH="/Users/apple/.nvm/versions/node/v24.15.0/bin:$PATH" pnpm docs:dev --host 127.0.0.1 --port 5173`，本地服务地址为 `http://127.0.0.1:5173/`。
